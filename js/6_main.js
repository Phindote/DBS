...
const itemWidth = dragItem.offsetWidth;
const minX = 10 - (window.innerWidth - 20 - itemWidth); 
const maxX = 0; 
const minY = headerHeight - (window.innerHeight - 80); 
const maxY = footerTop - window.innerHeight + 60; 
let finalX = currentX;
let finalY = currentY;
