...
div.innerHTML = `
<img src="images/achievements/${ach.id.replace('ach_', 'ach_')}.PNG" style="width:80px; height:80px; object-fit:contain; margin-bottom:10px;">
<div style="font-size:1.2rem; font-weight:bold; color:var(--primary-blue);">${ach.title}</div>
<div style="font-size:0.9rem; color:#555;">${ach.desc}</div>
`;
